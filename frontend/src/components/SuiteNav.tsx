import type { MetaEcosystem } from '../lib/types';

export default function SuiteNav(props: { current: 'ip' | 'dns' | 'tls' | 'lens'; meta?: MetaEcosystem }) {
  const links = () => [
    ...
    { id: 'lens', label: 'LENS', href: 'https://lens.netray.info' },
  ] as const;
